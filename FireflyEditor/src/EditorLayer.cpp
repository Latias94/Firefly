...
namespace Firefly
{
    ...
    EditorLayer::EditorLayer() : Layer("EditorLayer2D"), m_CameraController(1280.0f / 720.0f)
    {
    ...
    void EditorLayer::OnUpdate(Timestep ts)
    {
...

        {
            ...
            Renderer2D::DrawRotatedQuad({-2.0f, 0.0f, 0.0f}, {1.0f, 1.0f}, rotation, m_CheckerboardTexture,
                                        20.0f);
            Renderer2D::EndScene();
